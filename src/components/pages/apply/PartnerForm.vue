  ...
  <v-card color="white" rounded="xl" elevation="0" border style="border-color: #e8e0d8">
    ...
    <v-card-text class="pa-8 pa-md-10">
      ...
      <v-form ref="formRef" v-model="valid" @submit.prevent="handleSubmit">
        <v-row>
          <v-col cols="12" md="6"
            ><FormField label="Organization Name" v-model="form.organizationName" required
          /></v-col>
          <v-col cols="12" md="6"
            ><FormField label="Contact Person" v-model="form.contactPerson" required
          /></v-col>
          <v-col cols="12" md="6"
          ...
          /></v-col>
          <v-col cols="12" md="6"
            ><FormField label="Phone" v-model="form.phone" type="tel"
          /></v-col>
          <v-col cols="12" md="6">
